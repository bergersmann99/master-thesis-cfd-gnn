...
def process_simulation(sim_meta, vtk_base_dir, rng, k_neighbors=20, zones=None):
    ...
    # Input-Features: [x, y, z, wall_dist, node_type(7), U_ref, angle]
    n = n_subsampled
...
def main():
    ...
    parser.add_argument(
        "--subsample-level",
        choices=["coarse", "medium", "fine", "building_focus", "building_focus_25", "medium_no_cellvol"],
        default="medium_no_cellvol",
        help=(
            "Subsampling-Level:\n"
    ...
    print(f"")
    print(f"   Input-Features:    13 pro Knoten")
