"""
Überwacht das GCN Fine Training und dokumentiert alle 50 Epochen einen Zwischenstand.
"""
import re
import time
import subprocess
...
LOG_FILE     = Path("/home/tbergermann/Python/GNN/output_gcn_fine.log")
DOC_FILE     = Path("/home/tbergermann/Python/logs/GCN/training_GCN_fine.md")
TOTAL_EPOCHS = 800
...
def is_training_running():
    ...
    r = subprocess.run(["pgrep", "-f", "output_gcn_fine"], capture_output=True)
...
def append_table_row(doc_path, entry, lr_reductions_total):
    ...
    if marker in content:
        ...
        print(f"[Monitor GCN Fine] Epoche {entry['epoch']} dokumentiert.")
...
def main():
    ...
    while True:
        ...
        if not is_training_running():
            print("[Monitor GCN Fine] Training abgeschlossen.")
    ...
    print("[Monitor GCN Fine] Beendet.")
